                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Icon(Icons.announcement_outlined, color: Color.fromRGBO(255, 89, 0, 1)),
                            DropdownButton(
                              hint: Text('Selecciona importancia'),
                              items: _conceptType.map((value) => DropdownMenuItem(
                                child: Text(
                                  value,
                                ),
                                value: value
                          ...
                          padding: const EdgeInsets.all(12.0),
                           child: ElevatedButton.icon(
                             ...
                             onPressed: () {
                               ...
                               if(a != null && c != ''){
                                Map<String, dynamic> data = {"Asunto":a, "Comentario": c};
                                FirebaseFirestore.instance.collection("comentarios").add(data);
                                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Su comentario ha sido enviado exitosamente!"), backgroundColor: Colors.green));
                               _commentC.text = '';
                               selectectedType = null;
                               }else{
                                 ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Error. Completa la información necesaria"), backgroundColor: Colors.red));
                               }
                             },
